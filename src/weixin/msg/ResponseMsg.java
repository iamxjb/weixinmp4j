...
import weixin.msg.model.Image;
import weixin.msg.model.Music;
import weixin.msg.model.Text;
import weixin.msg.model.Video;
import weixin.msg.model.Voice;
import weixin.msg.model.Article;
...
public class ResponseMsg {
	...
	public String image(Image image){
		...
		//填充回复内容
		Element rootXML = new Element("xml");
		rootXML.addContent(new Element("ToUserName").setText(image.getToUserName()));
		rootXML.addContent(new Element("FromUserName").setText(image.getFromUserName()));
		rootXML.addContent(new Element("CreateTime").setText(Utils.getCurrentTime()));
	...
	public String voice(Voice voice){
		...
		//填充回复内容
		Element rootXML = new Element("xml");
		rootXML.addContent(new Element("ToUserName").setText(voice.getToUserName()));
		rootXML.addContent(new Element("FromUserName").setText(voice.getFromUserName()));
		rootXML.addContent(new Element("CreateTime").setText(Utils.getCurrentTime()));
	...
	public String video(Video video){
		...
		//填充回复内容
		Element rootXML = new Element("xml");
		rootXML.addContent(new Element("ToUserName").setText(video.getToUserName()));
		rootXML.addContent(new Element("FromUserName").setText(video.getFromUserName()));
		rootXML.addContent(new Element("CreateTime").setText(Utils.getCurrentTime()));
	...
	public String music(Music music){
		...
		//填充回复内容
		Element rootXML = new Element("xml");		
		rootXML.addContent(new Element("ToUserName").setText(music.getToUserName()));
		rootXML.addContent(new Element("FromUserName").setText(music.getFromUserName()));
		rootXML.addContent(new Element("CreateTime").setText(Utils.getCurrentTime()));
	...
	public String articles(List<Article> articles){
		...
		//填充回复内容
		Element rootXML = new Element("xml");
		rootXML.addContent(new Element("ToUserName").setText(articles.get(0).getToUserName()));
		rootXML.addContent(new Element("FromUserName").setText(articles.get(0).getToUserName()));
		rootXML.addContent(new Element("CreateTime").setText(Utils.getCurrentTime()));
